  ...
  <div class="progress-bar">
    ...
    <div class="progress-track">
      <div class="progress-fill">      
          <span class="percent" style="display:none;"><?php
...
if ($cb_count_trimmed5 > 100) {
	echo ('100');
} else if ($cb_count_trimmed5 < 1) {
echo ('0'); } else 
{ echo $cb_count_trimmed5; }
?>%</span>
...
<div id="point_count" class="rounded">
